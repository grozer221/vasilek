...
function ProfileInfo({ profile, status, updateStatus, isOwner, savePhoto, updateProfile }) {
  ...
  return (
    <div className={s.wrapper_profile}>
      ...
      {editMode
        ? <ProfileDataForm onSubmit={onSubmit} initialValues={profile} status={status} updateStatus={updateStatus}/>
